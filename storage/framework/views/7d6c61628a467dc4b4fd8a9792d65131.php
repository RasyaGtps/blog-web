    ...
    <div class="bg-white rounded-lg shadow p-6 space-y-8">
        ...
        <div>
            ...
            <div class="flex items-start space-x-6">
                <div class="relative">
                    <img src="/avatars/<?php echo e(Auth::user()->avatar); ?>" 
                         alt="<?php echo e(Auth::user()->name); ?>" 
                         class="w-32 h-32 rounded-full object-cover border-4 border-gray-200">
                </div>
                <div class="flex flex-col">
                    <form action="<?php echo e(route('profile.updateAvatar')); ?>" method="POST" enctype="multipart/form-data" class="space-y-2">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea id="bio" 
                          name="bio" 
                          rows="3"
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('bio', Auth::user()->bio)); ?></textarea>
                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
