...
<div class="container mx-auto px-4 py-8" x-data="{ createModal: false, editModal: false, selectedTag: null }">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <form action="<?php echo e(route('admin.tags')); ?>" method="GET" class="flex space-x-4">
                <div class="relative">
                    <input type="text" 
                           name="search"
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-[#2f2f2f]">
                    <td class="p-4">
                        <div class="font-medium text-white"><?php echo e($tag->name); ?></div>
                    </td>
                    <td class="p-4 text-gray-300"><?php echo e($tag->slug); ?></td>
                    <td class="p-4">
                        <span class="px-3 py-1 bg-[#2f2f2f] text-gray-300 rounded-full text-sm">
                            <?php echo e($tag->articles_count); ?>

                        </span>
                    </td>
                    <td class="p-4 text-right">
                        <div class="flex items-center justify-end space-x-3">
                            <button @click="editModal = true; selectedTag = <?php echo e($tag); ?>" 
                                    class="text-gray-400 hover:text-blue-400">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form action="<?php echo e(route('admin.tags.destroy', $tag)); ?>" 
                                  method="POST" 
                                  class="inline"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project-rasya\blogging\resources\views/admin/tags.blade.php ENDPATH**/ ?>