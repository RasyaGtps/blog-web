...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-400 mt-1">
                ...
                Total User: <?php echo e($users->total()); ?>
    ...
    <div class="bg-[#242424] rounded-lg shadow-lg p-6 mb-8">
        <form action="<?php echo e(route('admin.users')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="relative">
                <input type="text" 
                       name="search"
            ...
            <div class="relative">
                <select name="sort" 
                    ...
                    <option value="most_articles" <?php echo e(request('sort') === 'most_articles' ? 'selected' : ''); ?>>Artikel Terbanyak</option>
                    <option value="most_comments" <?php echo e(request('sort') === 'most_comments' ? 'selected' : ''); ?>>Komentar Terbanyak</option>
                </select>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-[#2f2f2f] transition-colors">
                    ...
                    <td class="p-4">
                        <?php if($user->membership === 'premium'): ?>
                            <span class="px-3 py-1 rounded-full text-xs font-medium bg-yellow-900/20 text-yellow-400">
                                Premium
                            </span>
                    ...
                    <td class="p-4">
                        <div class="flex items-center space-x-4 text-sm text-gray-400">
                            <span class="flex items-center gap-1" title="Artikel">
                                ...
                                <?php echo e($user->articles_count); ?>
                    ...
                    <td class="p-4">
                        <div class="text-sm text-gray-400">
                            <div><?php echo e(\Carbon\Carbon::parse($user->created_at)->translatedFormat('d F Y')); ?></div>
                            <div class="text-xs"><?php echo e(\Carbon\Carbon::parse($user->created_at)->format('H:i')); ?> WIB</div>
                        </div>
                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project-rasya\blogging\resources\views/admin/users/index.blade.php ENDPATH**/ ?>