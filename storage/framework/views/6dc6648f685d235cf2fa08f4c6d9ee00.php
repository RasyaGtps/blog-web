    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-400 mt-1">
                ...
                Edit informasi user <?php echo e($user->name); ?>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            <img id="avatar-preview" 
                                 ...
                                 src="<?php echo e($user->avatar ? asset('avatars/' . $user->avatar) : asset('images/default-avatar.png')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2">
                    ...
                    <select name="role" 
                        ...
                        <option value="verified" <?php echo e(old('role', $user->role) === 'verified' ? 'selected' : ''); ?>>Verified</option>
                    </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project-rasya\blogging\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>