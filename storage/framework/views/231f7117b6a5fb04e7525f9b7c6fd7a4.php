                ...
                <div class="space-y-2">
                    <div class="relative">
                        <div class="absolute left-0 top-1/2 -translate-y-1/2 flex items-center pl-4 pointer-events-none">
                            <i class="fas fa-user <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?> text-lg"></i>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" 
                            class="w-full pl-12 pr-4 py-4 rounded-full border <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    <div class="relative">
                        <div class="absolute left-0 top-1/2 -translate-y-1/2 flex items-center pl-4 pointer-events-none">
                            <i class="fas fa-at <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 <?php else: ?> text-gray-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-lg"></i>
                        ...
                        <input type="text" name="username" value="<?php echo e(old('username')); ?>"
                            class="w-full pl-12 pr-4 py-4 rounded-full border <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    <div class="relative">
                        <div class="absolute left-0 top-1/2 -translate-y-1/2 flex items-center pl-4 pointer-events-none">
                            <i class="fas fa-envelope <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 <?php else: ?> text-gray-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-lg"></i>
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>"
                            class="w-full pl-12 pr-4 py-4 rounded-full border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-lg hover:text-gray-600"></i>
                ...
                <div class="text-center text-sm text-gray-600 mt-6">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-green-600 hover:text-green-700">Sign in</a>
                </div>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\project-rasya\blogging\resources\views\auth\register.blade.php ENDPATH**/ ?>