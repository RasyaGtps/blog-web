    ...
    <div class="min-h-screen bg-[#1a1a1a]">
        ...
        <aside class="fixed inset-y-0 left-0 bg-[#242424] shadow-lg w-64 transform transition-transform duration-200 ease-in-out" 
            ...
            <nav class="py-4">
                ...
                <a href="<?php echo e(route('admin.tags')); ?>" 
                   class="flex items-center px-6 py-3 text-gray-300 hover:bg-[#2f2f2f] <?php echo e(request()->routeIs('admin.tags') ? 'bg-[#2f2f2f] text-white' : ''); ?>">
