...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.articles.store')); ?>" 
              method="POST" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="description" 
                              rows="3"
                              required
                              class="w-full bg-[#2f2f2f] text-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="content" 
                              rows="10"
                              required
                              class="w-full bg-[#2f2f2f] text-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="type" 
                            required
                            class="w-full bg-[#2f2f2f] text-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="free" <?php echo e(old('type') === 'free' ? 'selected' : ''); ?>>Free</option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project-rasya\blogging\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>