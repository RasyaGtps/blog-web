    ...
    <div class="max-w-[1200px] mx-auto px-4 py-4">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500">
                <a href="<?php echo e(route('stories.index')); ?>" class="hover:text-black">Our Story</a>
                <a href="<?php echo e(route('membership.index')); ?>" class="hover:text-black">Membership</a>
...
</footer> <?php /**PATH C:\project-rasya\blogging\resources\views/layouts/footer.blade.php ENDPATH**/ ?>