...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(auth()->user()->role === 'verified'): ?>
                    <div class="mb-6">
                        ...
                        <div class="flex gap-4" x-data="{ selectedType: '<?php echo e(old('type', 'free')); ?>' }">
                            <!-- Free Option -->
...
</html><?php /**PATH C:\project-rasya\blogging\resources\views/articles/create.blade.php ENDPATH**/ ?>